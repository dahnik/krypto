...
public class AES {
	...
	public static void main(String[] args) throws IOException
	{
		...
		char[] pass={'1','2','3','4','5','6'};//cons.readPassword();
		//Scanner input = new Scanner(System.in);
		//System.out.println("Please enter path to file which u want to encrypt");
		//String path1 = input.nextLine(); //C:/Users/dahnik/aaa.txt
		String path1 = "/home/dahn/test/aaa.txt";
		...
		try 
		{
		    ...
		    String plik1 = "/home/dahn/test/zaszyfrowany.txt";
		    String plik2 ="/home/dahn/test/odszyfrowany.txt";
